...
var SuspenseImage = /*#__PURE__*/function (_Component) {
  ...
  function SuspenseImage() {
    ...
    _this.start = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      var _this$props, src, fallback, delay, errorMessage, uri;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              if (delay && delay > 0) {
                _this.timeoutId = setTimeout(function () {
                  ...
                  if (!_this.state.src && !_this.state.error && _this._isMounted) {
                    _this.setState({
                      isLoading: true
                    });
                  }
            ...
            case 14:
              ...
              if (!(_context.t0 instanceof IntendedError) && _this._isMounted) {
                _this.setState({
                  error: _context.t0,
                  isLoading: false
                });
    ...
    _this.loadImage = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(uri) {
        var onLoad;
              ...
              case 0:
                ...
                return _context3.abrupt("return", new Promise(function (resolve, reject) {
                  if (_this.img) {
                    ...
                    _this.img.onerror = null; // Previous promise call must be cancelled for decode().

                    // Previous promise call must be cancelled for decode().
                    _this.forceReject && _this.forceReject(new IntendedError());
                  }
  ...
  _proto.render = function render() {
    ...
    var _ref4 = NativeImgProps || {},
        className = _ref4.className,
        stripClassname = _objectWithoutPropertiesLoose(_ref4, _excluded);

    if (isLoading) {
      return fallback;
    } else if (error) {
      return errorFallback ? errorFallback(error) : React__default.createElement("span", {
        role: "button",
...
exports.Image = SuspenseImage;
exports.Shimmer = Shimmer;
//# sourceMappingURL=react-shimmer.cjs.development.js.map
